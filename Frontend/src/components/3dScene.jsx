...
const StructuralViewer3D = () => {
  ...
  useEffect(() => {
    ...
    scene.add(xyGrid);
    scene.add(new THREE.GridHelper(size, divisions));            // XZ
    const yzGrid = new THREE.GridHelper(size, divisions);
...
export default StructuralViewer3D;
