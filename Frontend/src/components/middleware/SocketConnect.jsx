...
import { useDataCentre } from './DataCentre';
...
export default function SocketConnect() {
  ...
  return (
    <div className="socket-container">
      ...
      {/* 6. Show “Download Generated Python Script” button once we have receivedFile */}
      {receivedFile && (
        <div style={{ marginTop: '1rem' }}>
          ...
          >
            {downloading ? 'Downloading…' : `Download: ${receivedFile.filename}`}
          </button>
        </div>
      )}
